...
public class ReservationRepositoryTest {
  ...
  void testFindReservationById() {
    Long lastReservationId = reservationRepository
  ...
  void testFindReservationsByMemberId() {
    ...
    int foundReservations = reservationRepository
      .findReservationsByMemberId(memberId)
      .size();
  ...
  void testFindReservationsByRentalDate() {
    int foundReservations = reservationRepository
      .findReservationsByRentalDate(LocalDate.of(2021, Month.JANUARY, 25))
      .size();
    assertEquals(1, foundReservations);
  }
