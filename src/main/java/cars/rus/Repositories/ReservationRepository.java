...
public interface ReservationRepository
  ...
  public Collection<Reservation> findReservationsByRentalDate(
    LocalDate rentalDate
  );

  public Optional<Reservation> findReservationByCarIdAndRentalDate(
    Long carId,
    LocalDate rentalDate
  );

  public Optional<Reservation> findReservationByMemberIdAndRentalDate(
    Long memberId,
    LocalDate rentalDate
  );
